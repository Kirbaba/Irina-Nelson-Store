...
function add_style(){
    ...
    wp_enqueue_style( 'slick', '//cdn.jsdelivr.net/jquery.slick/1.5.7/slick.css', array('my-bootstrap-extension'), '1');
...
function add_script(){
    ...
    wp_enqueue_script( 'slick', get_template_directory_uri() . '/js/fotorama.js', array(), '1');    
